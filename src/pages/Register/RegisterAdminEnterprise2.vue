										...
										<section class="margin-button">
											...
											<div class="field">
												<b-select class="form-fields form-select is-large"
													...
													<option disabled="disabled" hidden value=0 selected>Pais</option>
													<option
														v-for="option in data"
														:value="option"
														:key="option">
											...
											<div class="field">
												...
												<option disabled="disabled" hidden value=0 selected>Ciudad</option>
												<option
													v-for="option in data"
													:value="option"
													:key="option">
...
export default class RegisterAdminEnterprise2 extends PageBase {
	public register_form: RegisterAdminEnterprise2Form = new RegisterAdminEnterprise2Form({});
