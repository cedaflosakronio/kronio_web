<template>
	<modal name="md-import-employee" width="35%" height="auto" :scrollable="true" :adaptive="true" :min-width="350">
		<div class="example-modal-content">
			...
			<p class="title-employee">Crear empleado</p>
			<p class="subtitle-employee">Rellena la información personal del empleado para poder crearlo</p>
			<div class="columns is-centered"></div>
			<div class="columns caja-input">
				<div class="column is-full">
					<div class="field tarjeta">
						<p class="label-left-descripcion">Correo electrónico</p>
						<div class="control">
							<input
			...
			<div class="columns caja-input-second">
				<div class="column">
					<div class="field tarjeta">
			...
			<div class="columns is-centered">
				<div class="column is-10">
					<button class="button btn-wellcome is-fullwidth">Enviar envitación</button>
				</div>
			</div>
		</div>
	</modal>
